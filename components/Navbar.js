...
const Navbar = () => {
  ...
  // }
  return (
    <nav className='bg-gray-900 text-white flex items-center justify-between px-4 md:h-16 w-[118vw] md:w-[100vw] flex-col md:flex-row' >
      ...
      <div className='relative xs-max:flex xs-max:flex-col md:block xs-max:gap-4'>
        ...
        {session && <>
          ...
          <div id="dropdown" className={`z-10 ${showdropdown ? "" : "hidden"} absolute left-[125px] top-12 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}>
